...
// Route login & logout
Route::get('/login', [AuthController::class, 'index'])->name('login'); // ini penting
Route::post('/login', [AuthController::class, 'login']); // cukup tanpa nama, biar gak konflik
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Route::get('/admin/penjualan/export', [PenjualanController::class, 'export'])->name('penjualan.export');
    // Route::get('/admin/penjualan/{id}/unduh-bukti', [PenjualanController::class, 'unduhBukti'])->name('penjualan.pdf');
